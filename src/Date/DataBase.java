...
public class DataBase {
    ...
    public double getDiscountOfCard (String cardNumber)
    {
        ...
        {
            return cardDiscont.get(cardNumber); //возвращает скидку по карте, если такая карта существует
        }
        return 0;
    }
}
